...
<table width="700" align="center">
	...
	<tr><td><img src="goods/images/${dto.goodsImage }" width ="30" /></td>
...
<input type="hidden" name="totalPaymentPrice" value="${goodsTotalPrice + totalDeliveryCost }" />
<table width="700"  align="center">
	<tr><td>
			<table width="350">
		...
		<td>
			<table width="350">
				...
				<tr><td> 총 금액 </td><td align="right">${goodsTotalPrice}원</td></tr>
				<tr><td> 총 배송비</td><td align="right">${totalDeliveryCost }원</td></tr>
				<tr><td> 총 결제 금액 </td>
					<td align="right">${goodsTotalPrice + totalDeliveryCost }원 </td></tr>
