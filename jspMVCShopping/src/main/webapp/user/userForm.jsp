...
<tr><th width="150px">*아이디</th>
	<td width="450px"><input type="text" name="memberId" id="userId" required="required" 
		readonly="readonly"/>
...
<tr><th >*회원명</th>
	<td ><input type="text" name="memberName" id="memberName"required="required"/></td></tr>
<tr><th >*회원연락처1</th>
	<td ><input type="tel" name="memberPhone1" required="required"/></td></tr>
<tr><th >회원연락처2</th>
	<td ><input type="tel" name="memberPhone2" required="required"/></td></tr>
<tr><th >*회원주소</th>
	<td ><input type="text" name="memberAddr" id="sample4_roadAddress" required="required" 
			readonly="readonly"/>
		 <button type="button" onclick="execDaumPostcode();">주소검색</button></td></tr>
<tr><th >상세주소</th>
	<td ><input type="text" name="memberAddrDetail" /></td></tr>
<tr><th >*우편번호</th>
	<td ><input type="text" name="memberPost" id="sample4_postcode"  required="required" 
...
<tr><th  colspan="2"><input type="submit" value="회원가입" />
						  <input type="button" value="회원가입취소"></th></tr>	
</table>
</form>
</body>
</html>