...
public class GoodsWriteService {
	public void execute(HttpServletRequest request) {
		...
		String realPath = request.getServletContext().getRealPath("goods/images");
		try {
			...
			String goodsImages = image1StoreName + "`" + image2StoreName + "`"
	                   			+ image3StoreName;
			String goodsImagesImg = image1OriginalName + "`" + image2OriginalName + "`"
			              		+ image3OriginalName;
